...
public class MinusButtonHandler implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String result = Integer.toString(arithmetic.minus(Integer.parseInt(basicArithmeticOperation.substring(0, basicArithmeticOperation.length() - 6)), Integer.parseInt(basicArithmeticResultHolder)));
