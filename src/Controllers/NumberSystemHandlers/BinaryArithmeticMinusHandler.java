...
public class BinaryArithmeticMinusHandler implements ActionListener {
    ...
    public BinaryArithmeticMinusHandler (NumberSystemBottomRightContainer _numberSystemBottomRightContainer, NumberSystem _numberSystem, BinaryArithmetic _binaryArithmetic) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        numberSystemBottomRightContainer.binaryOutput.setText(Long.toString(binaryArithmetic.binarySubtraction(Long.parseLong(firstInput), Long.parseLong(secondInput))));
