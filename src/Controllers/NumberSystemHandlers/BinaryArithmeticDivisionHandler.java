...
public class BinaryArithmeticDivisionHandler implements ActionListener {
    ...
    public BinaryArithmeticDivisionHandler (NumberSystemBottomRightContainer _numberSystemBottomRightContainer, NumberSystem _numberSystem, BinaryArithmetic _binaryArithmetic) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        numberSystemBottomRightContainer.binaryOutput.setText(Long.toString(binaryArithmetic.binaryDivision(Long.parseLong(firstInput), Long.parseLong(secondInput))));
