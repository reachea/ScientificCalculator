...
public class BinaryArithmeticSumHandler implements ActionListener {
    ...
    public BinaryArithmeticSumHandler (NumberSystemBottomRightContainer _numberSystemBottomRightContainer, NumberSystem _numberSystem, BinaryArithmetic _binaryArithmetic) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        numberSystemBottomRightContainer.binaryOutput.setText(Long.toString(binaryArithmetic.binaryAdd(Long.parseLong(firstInput), Long.parseLong(secondInput))));
