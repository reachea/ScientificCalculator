...
public class MinusButtonHandler implements ActionListener {
    protected BasicOperationLeftContainer basicOperationLeftContainerView;
    protected Arithmetic arithmetic;

    public MinusButtonHandler(BasicOperationLeftContainer _basicOperationLeftContainerView, Arithmetic _arithmetic) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String result = Double.toString(arithmetic.minus(Double.parseDouble(basicArithmeticOperation.substring(0, basicArithmeticOperation.length() - 6)), Double.parseDouble(basicArithmeticResultHolder)));
