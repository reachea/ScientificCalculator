...
public class BasicOperationLeftContainer extends JPanel {
    ...
    public void createGridButtons() {
        ...
        dpButton.setText(".");
        dpButton.addActionListener(new DpButtonHandler());
    ...
    public void addMultipleButtonHandler(ActionListener multipleBtnHandler) {
        multiplyButton.addActionListener(multipleBtnHandler);
    }
